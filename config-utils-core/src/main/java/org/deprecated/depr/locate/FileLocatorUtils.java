 ...
 */
package org.deprecated.depr.locate;
...
import org.deprecated.depr.FileUtils;

/**

 *
 * @version $Id: FileLocatorUtils.java 1750126 2016-06-24 15:49:12Z oheger $
 * @since 2.0
 */
public final class FileLocatorUtils
{
     ...
     * are passed to the current {@code FileSystem}'s {@code locateFromFileSystemURL()}
     ...
     * platforms you should never let relative location start with a slash. E.g.
    ...
    public static URL locateFromURL(String basePath, String fileName) {
        try {
            ...
            FileUtils.logger.debug("Could not locate file " + fileName + " at " + basePath + ": " + e.getMessage());
