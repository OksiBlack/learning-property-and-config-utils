 ...
 * {@code FileHandler} change or when a getProperties or save operation is performed.
 * This can be useful for various use cases, e.g. when monitoring file-based
 * configurations.
 * </p>
 *
 * @version $Id: FileHandlerListener.java 1624601 2014-09-12 18:04:36Z oheger $
 * @since 2.0
 */
public interface FileHandlerListener
{
     ...
     * is called immediately before the getProperties operation.
     *
     ...
     * called directly after the getProperties operation.
     *
     * @param handler the file handler
     */
