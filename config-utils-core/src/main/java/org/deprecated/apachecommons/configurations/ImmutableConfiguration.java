 ...
 */
package org.deprecated.apachecommons.configurations;
 ...
 * data type. If this fails, a {@code RuntimeException} will be thrown.</p>
 ...
 *
 * @version $Id: ImmutableConfiguration.java 1819882 2018-01-02 19:59:19Z oheger $
 * @since 2.0
 */
public interface ImmutableConfiguration
{
     ...
     * @throws RuntimeException is thrown if the
     ...
     * @return The associated long.
     *
     * @throws RuntimeException is thrown if the key maps to an
     ...
     *
     * @throws RuntimeException is thrown if the key maps to an object that
     *         is not a String.
     */
     ...
     * @throws RuntimeException if the value is not compatible with the
     *         requested type
     * @since 2.0
     */
     ...
     * @return the value of the requested type for the key
     *
     * @throws RuntimeException if the value is not
